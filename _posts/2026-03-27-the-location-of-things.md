...
In the above, the bold prompt asks where is the location of the bag. The italicized response says it's to the left of the desk. Notice the use of [subject markers](https://k.svmiller.com/blog/2026/03/i-ga) to emphasize the thing that needs a location. Notice as well the use of 에 as a location marker.
